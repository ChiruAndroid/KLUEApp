            ...
            public void onClick(View v) {
                if (!preferenceUtils.getbooleanFromPreference(PreferenceUtils.LOG_OUT, true)) {
                    if (!list.get(position).isChecked()) {
                        ...
                        TopPicsFragment.top_pics_list.get(position).setChecked(true);
                        TopPicsFragment.top_pics_list.get(position).setIs_wish_list(1);
                        ...
                        TopPicsFragment.top_pics_list.get(position).setChecked(false);
                        TopPicsFragment.top_pics_list.get(position).setIs_wish_list(0);
                    ...
                    showDialog(context, SweetAlertDialog.WARNING_TYPE, "", context.getString(R.string.plz_login_add_into_fav), "OK!",
